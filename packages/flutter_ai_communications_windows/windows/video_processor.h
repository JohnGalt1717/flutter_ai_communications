#ifndef FLUTTER_PLUGIN_WINDOWS_VIDEO_PROCESSOR_H_
#define FLUTTER_PLUGIN_WINDOWS_VIDEO_PROCESSOR_H_
...
class PersonBackgroundProcessor {
 public:
  ...
  std::string Apply(const flutter::EncodableMap& args);
...
#endif  // FLUTTER_PLUGIN_WINDOWS_VIDEO_PROCESSOR_H_
